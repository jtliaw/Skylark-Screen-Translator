...
from google_api_switcher import APIEndpointDialog, GoogleAPIManager
...
class ScreenTranslator(QMainWindow):
    ...
    def __init__(self):
        ...
        # 设置窗口属性
        self.setWindowTitle("Skylark Translation V2.0 - 在线/离线翻译版")
        self.setGeometry(100, 100, 650, 370)  # 稍微增大窗口
    ...
    def init_ui(self):
        ...
        self.endpoint_manager_btn = QPushButton("Google API管理")
    ...
    def open_endpoint_manager(self):
        """打开Google API端点管理"""
        if not hasattr(self, 'endpoint_dialog'):
