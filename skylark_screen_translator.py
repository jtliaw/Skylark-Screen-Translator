...
class PackageInfoDialog(QDialog):
    ...
    def setup_dialog_size(self):
        ...
        try:
            ...
            self.setFixedSize(width, height)  # 固定大小
    ...
    def setup_dialog_size(self):
        ...
        try:
            ...
            if system == "Windows":
                ...
                # 根据屏幕大小调整对话框尺寸
                if screen_width >= 1920 and screen_height >= 1080:  # 高分辨率
                    width = 850
                    height = 650
                elif screen_width >= 1366 and screen_height >= 768:  # 标准分辨率
                    width = 750
                    height = 550
                else:  # 较小屏幕
                    width = 650
...
class ScreenTranslator(QMainWindow):
    ...
    def configure_api_settings(self):
        ...
        if current_engine == 'deepl':
            ...
            layout.addWidget(QLabel("Mymemory翻译使用免费服务，无需API密钥。"))
            layout.addWidget(QLabel("LibreTranslate翻译使用免费服务，无需API密钥。"))
            layout.addWidget(QLabel("Google翻译非官方授权，法律或风险由用户自行承担。"))
