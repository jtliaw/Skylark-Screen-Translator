...
from PyQt5.QtCore import Qt, QRect, QTimer, QPoint, QEvent, QThread, pyqtSignal, QLibraryInfo, QSize, QMetaType
...
class ScreenTranslator(QMainWindow):
    ...
    def __init__(self):
        ...
        # 设置窗口属性
        self.setWindowTitle("Skylark Translation V3.0 - 扫描屏幕翻译软件")
